 ...
 */
    ...
    // --------------- Local type
    /**
     * SaveFileFunction must be defined by caller as callback. In August 2024, it is intended to be
     * used with the Thunderbird experimental API messenger: messenger.localSaveFile.saveFile
     */
    type SaveFileFunction = (filename: string, filedata: ArrayBuffer) => Promise<number>
     ...
     * @param {SaveFileFunction} saveFile is the function to call to save the file (check comment in
     *                       definition of <code>SaveFileFunction</code>).
     *                       In Thunderbird addin with the experimental saveFile API, you can provide
     *                       "messenger.localSaveFile.saveFile" as function.
     ...
     */
    export async function saveBlob (saveFile: SaveFileFunction,
        ...
        try {
            ...
            if ((absolutePath === cNullString) || (filename === cNullString)) {
                ...
                await saveFile(fullname, dataBuffer)
